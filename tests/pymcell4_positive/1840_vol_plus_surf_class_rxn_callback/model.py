...
def check_pos3d(pos3d):
    ...
    assert pos3d.x >= -0.05 - EPS and pos3d.x <= 0.05 + EPS
    assert pos3d.y >= -0.05 - EPS and pos3d.y <= 0.05 + EPS
    #print(pos3d.z)
    assert pos3d.z >= -0.05 - EPS and pos3d.z <= 0.05 + EPS
...
rxn_found = model.find_reaction_rule('rxn')
assert rxn_found is rxn
