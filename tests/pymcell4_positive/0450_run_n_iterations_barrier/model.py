...
model.config.subpartition_dimension = 10.01
...
# the previous issue was that diffusion was scheduled over the barrier
# that is the end of the simulated time 
mol = model.get_molecule(0)
