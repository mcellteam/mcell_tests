...
observables.load_bngl_observables('test.bngl', './react_data/seed_' + str(SEED).zfill(5) + '/counts.gdat')
observables.add_viz_output(viz_output)

observables2 = m.Observables()
observables2.load_bngl_observables('test.bngl', './react_data/seed_' + str(SEED).zfill(5) + '/counts2.gdat')
...
model.add_observables(observables2)
