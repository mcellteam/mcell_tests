...
if __name__ == "__main__":
	...
	rxn_sym = m.create_reaction(
		world=world,
		reactants=r_spec_list,
		products=p_spec_list,
		rate_constant=1.0,
		name = "a_plus_b" # named reaction cannot be reversible
		)

	# for usage, see pymcell_helpers.py - add_rxn_count, 
	# that however does not work for some reason  
	# the last argument is periodicity of outputs 
	m.create_rxn_count(world, None, rxn_sym, "a_plus_b_rxn_count.dat", 0.1)
